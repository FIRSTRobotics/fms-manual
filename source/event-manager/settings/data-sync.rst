...
Beyond the enable setting, status information is displayed for use by FRC Engineering when performing advanced sync related tasks- it's not useful to (or available to) the end user.
