...
The same data is available via the :ref:`field-server-logs-scores` page of the Field Monitor, which is especially useful for allowing Field Staff to review data without interrupting match play.
