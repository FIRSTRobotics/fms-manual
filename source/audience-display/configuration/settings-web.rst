...
Access the settings from the Audience Display hover menu and clicking the Gear icon, or use the keyboard shortcut ALT-C when the Audience Display program is in focus.

Configuration ID
----------------

.. image:: images/audience-settings-web-0.png
    :align: center
...
.. image:: images/audience-settings-web-1.png
    :align: center

|
| [**Display Language**] Audience Display is available in multiple languages- select a language from the dropdown

.. image:: images/audience-settings-web-2.png
    :align: center

| 
| [**Resolution**] The Audience Display is available in **1280 x 720** or **1920 x 1080** resolutions. Ask your event production crew for more information.

Graphics Settings
------------------

.. image:: images/audience-settings-web-3.png
    :align: center
...
[**Background Chroma Key**] Select the color to be used for the Chroma Key (if in Chroma mode). In most cases, the deault "Fuchsia" should work great. The desired color will be dictated by the event's production
...
.. image:: images/audience-settings-web-5.png
    :align: center
...
|
| [**Horizontal Orientation**] The red alliance is setup to the right side when viewed from the scoring table. As such, a projection screen mounted behind the scoring 
...
.. image:: images/audience-settings-web-7.png
    :align: center
...
.. image:: images/audience-settings-web-8.png
    :align: center
...
.. image:: images/audience-settings-web-9.png
    :align: center
...
.. image:: images/audience-settings-web-10.png
    :align: center
