...
[*Right*] Playoff Matches Round 5 (Finals) - The bracket progression tracking is replaced with "first to 2" progression
...
Match results is used to show the audience the final scores of the match they just witnessed. Team numbers, yellow/red cards, new rankings and
more are shown. Also shown are the scoring details for the match and the match outcome (which alliance is victorious).

[*Left*] Qualification Matches - Ranking point icons are also shown to indicate the number of RPs awarded

[*Middle*] Playoff Matches Rounds 1-4 - Alliance number is shown in the background on the red and blue sides, and where in the bracket the alliance is headed (based on the outcome) is in the box under the team numbers

[*Right*] Playoff Matches Round 5 (Finals) - The number of wins is shown under the team numbers

An EVENT HIGH SCORE indicator if one or both of the teams broke the previous high score for the tournament (this is event specific, and checks both qual and playoff matches).
