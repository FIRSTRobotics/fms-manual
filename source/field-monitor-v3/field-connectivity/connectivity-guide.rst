.. _field-monitor-v3-connectivity-guide:
...
:ref:`Status Indicators <field-monitor-v3-status-indicators>` describes all of the potential status indicators in detail.
